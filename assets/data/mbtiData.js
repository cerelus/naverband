...
const qnaData = [
  {
    ...
    a: [
      { desc: '하루 놀면 하루 휴식! 징검다리 필수', type: 'E', score: 1 },
      { desc: '3일 연속 약속도 거뜬', type: 'E', score: 2 },
      { desc: '일주일에 한 번도 고민', type: 'E', score: 0 },
    ],
  },
  {
    q: '선호하는<br>약속 장소는?',
    a: [
      { desc: '웨이팅, 두렵지 않아! 핫플로', type: 'E', score: 1 },
      { desc: '조용한 곳이 좋아! 한적한 골목길로', type: 'E', score: 0 },
    ],
  },
  {
    q: '장소가 정해졌다!<br>그럼 나는',
    a: [
      { desc: '주변 맛집 놀거리 모두 탐색 완료!', type: 'P', score: 0 },
      { desc: '당일에 알아보고 바로 출발', type: 'P', score: 2 },
      { desc: '얼마나 걸리지? 가는 길 미리 체크', type: 'P', score: 1 },
    ],
  },
  {
    q: '내일은 약속 날!<br>단체 그룹방은 잠잠한데..',
    a: [
      { desc: '어디서 볼래? 먼저 연락하기', type: 'E', score: 1 },
      { desc: '누가 말 꺼내기 전까지 기다리기', type: 'E', score: 0 },
    ],
  },
  {
    q: '약속 장소에<br>늦게 도착했을 때 나는',
    a: [
      { desc: '왜 늦었는지 설명부터', type: 'T', score: 1 },
      { desc: '일단 사과부터', type: 'T', score: 0 },
    ],
  },
  {
    q: '가기로 했던 식당이 닫았다!<br>어디로 가지?',
    a: [
      { desc: '바로 옆에 있는 새로운 식당', type: 'N', score: 1 },
      { desc: '가본 적 있는 식당', type: 'N', score: 0 },
    ],
  },
  {
    q: '가고 싶었던 카페 도착!<br>아무도 없이 휑한 분위기에 나는',
    a: [
      { desc: '감각을 믿고 우선 들어간다', type: 'N', score: 1 },
      { desc: '다른 카페를 검색한다', type: 'N', score: 0 },
    ],
  },
  {
    q: '카페에서 메뉴 선택 중<br>어떤 걸 마셔볼까?',
    a: [
      { desc: '사장님 추천! 랜덤 음료', type: 'N', score: 2 },
      { desc: '카페 시그니처 메뉴', type: 'N', score: 1 },
      { desc: '무난하게 아메리카노', type: 'N', score: 0 },
    ],
  },
  {
    q: '친구가 고민을<br>털어놓을 때, 나는',
    a: [
      { desc: '진짜 힘들었겠다. 기분은 괜찮아?', type: 'T', score: 0 },
      { desc: '그래서 지금은 해결된 거야?', type: 'T', score: 1 },
    ],
  },
  {
    q: '친구와 의견이<br>갈릴 때 나는',
    a: [
      { desc: '‘난 다르게 생각해’ 토론 모드 돌입', type: 'T', score: 2 },
      { desc: '‘네 말이 맞는 거 같아’ 100% 끄덕끄덕', type: 'T', score: 0 },
      { desc: '‘음, 그럴 수 있지’ 마인드 장착', type: 'T', score: 1 },
    ],
  },
  {
    q: '친구가 ‘우리 이제 뭐 하지?’<br>라고 물었을 때',
    a: [
      { desc: '일단 나가서 뭐 있는지 보고 정할까?', type: 'P', score: 1 },
      { desc: '이다음은 여기! 플랜대로 이동!', type: 'P', score: 0 },
    ],
  },
  {
    q: '한가로운 주말, 친구가<br>집 근처로 나오라고 한다면?',
    a: [
      { desc: '지금…? 급작스러운 제안에 당황한다', type: 'P', score: 0 },
      { desc: '편안한 차림으로 바로 나간다', type: 'P', score: 1 },
    ],
  },
];
...
const resultData = [
  {
    ...
    image: './assets/images/mbti/type01.png',
    color: '#bb58ea',
    info: [
    ...
    band: [
      {
        name: '취미 인기 밴드',
        image: './assets/images/mbti/band15.png',
        link: 'https://band.us/keyword-group/%EC%B7%A8%EB%AF%B8',
      },
      {
        name: '습관 미션 인증 밴드',
        image: './assets/images/mbti/band16.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type02.png',
    color: '#bb58ea',
    info: [
      '계획과 원칙은 나를 상징하는 단어',
    ...
    band: [
      {
        name: '경제/재테크 인기 밴드',
        image: './assets/images/mbti/band14.png',
      ...
      {
        name: '글쓰기 미션 인증 밴드',
        image: './assets/images/mbti/band03.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type03.png',
    color: '#07b53b',
    info: [
  ...
  },
  {
    ...
    image: './assets/images/mbti/type04.png',
    color: '#07b53b',
    info: [
      '여러 분야에서 다재다능한 재주꾼',
      '눈치가 빨라서 상황 파악이 빠른 편',
    ...
    band: [
      {
        name: 'IT 인기 밴드',
        image: './assets/images/mbti/band20.png',
        link: 'https://band.us/keyword-group/IT%2F%EC%BB%B4%ED%93%A8%ED%84%B0/IT',
      },
      {
        name: '스터디 미션 인증 밴드',
        image: './assets/images/mbti/band09.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type05.png',
    color: '#1ba7e9',
    info: [
      '스스로에게 엄격한 완벽주의자',
    ...
    band: [
      {
        name: '드라마 인기 밴드',
        image: './assets/images/mbti/band08.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type06.png',
    color: '#1ba7e9',
    info: [
      '아늑하고 감성적인 분위기를 선호',
      '이야기를 잘 들어주는 프로경청러',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type07.png',
    color: '#fe747e',
    info: [
      '스스로에게 엄격한 완벽주의자',
      '나만의 사회생활용 부캐 소유',
    ...
    band: [
      {
        name: '공부 인기 밴드',
        image: './assets/images/mbti/band25.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type08.png',
    color: '#fe747e',
    info: [
      '내 관심사가 나오면 수다쟁이로 변신',
    ...
    band: [
      {
        name: '인문/과학 인기 밴드',
        image: './assets/images/mbti/band02.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type09.png',
    color: '#bb58ea',
    info: [
  ...
  },
  {
    ...
    image: './assets/images/mbti/type10.png',
    color: '#bb58ea',
    info: [
      '효율을 중시하는 능률형 인간',
    ...
    band: [
      {
        name: '건강/다이어트 인기 밴드',
        image: './assets/images/mbti/band17.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type11.png',
    color: '#07b53b',
    info: [
    ...
    band: [
      {
        name: '힙합 인기 밴드',
        image: './assets/images/mbti/band24.png',
        link: 'https://band.us/keyword-group/%EC%9D%8C%EC%95%85/%ED%9E%99%ED%95%A9',
      },
      {
        name: '운동 미션 인증 밴드',
        image: './assets/images/mbti/band05.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type12.png',
    color: '#07b53b',
    info: [
  ...
  },
  {
    ...
    image: './assets/images/mbti/type13.png',
    color: '#1ba7e9',
    info: [
    ...
    band: [
      ...
      {
        name: '미션 인증 밴드',
        image: './assets/images/mbti/band07.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type14.png',
    color: '#1ba7e9',
    info: [
  ...
  },
  {
    ...
    image: './assets/images/mbti/type15.png',
    color: '#fe747e',
    info: [
    ...
    band: [
      {
        name: '스포츠/레저 인기 밴드',
        image: './assets/images/mbti/band04.png',
  ...
  },
  {
    ...
    image: './assets/images/mbti/type16.png',
    color: '#fe747e',
    info: [
      '어디에서든 자신감 넘치는 사람!',
    ...
    band: [
      {
        name: '캠핑/백패킹 인기 밴드',
        image: './assets/images/mbti/band06.png',
